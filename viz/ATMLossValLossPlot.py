...
#	"permissions": "public",
#	"properties": [
#		{ "name": "parm1" , "field": "parm1", "kind": "string", "minlen": 1, "maxlen": 62, "required": true, "default": "loss" },
#		{ "name": "parm2" , "field": "parm2", "kind": "string", "minlen": 1, "maxlen": 62, "required": true, "default": "val_loss" }
#	],
